...
namespace BaldurSuchtFiona.Screens
{
    ...
    internal class Armor2Screen : Screen
    {
        private List<Item> Speicher;

        public Armor2Screen (ScreenComponent manager) : base (manager, new Point (400, 300))
        {
        ...
        public new void Draw (GameTime gameTime, SpriteBatch batch)
        {
            ...
            batch.Draw (Manager.CollectableIcons, new Rectangle ((Manager.GraphicsDevice.Viewport.Width / 2) - 32, (Manager.GraphicsDevice.Viewport.Height / 2) - 32, 64, 64), new Rectangle (32, 128, 32, 32), Color.White);
        }
        ...
        public override void Update (GameTime gametime)
        {
            if (!Manager.Game.Input.Handled) {
                ...
                if (Manager.Game.Input.Interact) {
                    ...
                    Manager.Game.Baldur.Inventory.Add (new Armor (Manager.Game, 2));
